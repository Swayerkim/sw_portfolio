...
##Classes of Restricted Estimators
 ...
 비모수회귀나 다양한 학습 방법들은 우리가 추가하는 제약이 어떤 nature를 갖느냐에 따라 다르게 분류된다. 이 챕터에서는 넓은 의미로 3가지로 분류하여 설명을 한다.
...
####Roughness Penalty and Bayesian Methods
 ...
 roughness penalty는 $f$의 큰 2차미분 값들에 영향을 미치며, penalty의 정도는 $\lambda \geq 0$인 $\lambda$에 의해 표현된다. $\lambda=0$ 는 penalty가 존재하지 않음을 의미하며, $\lambda = \infty$ 의 경우는 오로지 x내의 선형함수만을 허용하게 된다.
...
####Kernal Methods and Local Regression
