...
![](HW3_files/figure-html/unnamed-chunk-7-2.png)<!-- -->
...
![](HW3_files/figure-html/unnamed-chunk-7-3.png)<!-- -->
...
![](HW3_files/figure-html/unnamed-chunk-7-4.png)<!-- -->
...
![](HW3_files/figure-html/unnamed-chunk-7-5.png)<!-- -->


## Estimating the speed of light using normal model

## Binomial regression and grid sampling with bioassay data
